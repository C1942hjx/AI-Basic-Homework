...
项目需要使用模型 `intfloat/e5-small-v2` 进行向量检索，请前往 [Hugging Face 官网](https://huggingface.co/) 或者 [镜像网站](https://hf-mirror.com/) 进行下载。具体步骤可以参考 [这篇文章](https://zhuanlan.zhihu.com/p/663712983)。将下载好的模型文件夹命名为 `e5-small-v2`，并放在 `main.py` 所在目录中。
